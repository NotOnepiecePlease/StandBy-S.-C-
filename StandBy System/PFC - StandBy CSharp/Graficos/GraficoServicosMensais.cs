...
namespace PFC___StandBy_CSharp.Graficos
{
    ...
    {
        public async Task Preencher(BunifuDataViz bunifuDataViz2, int _mes, Label lblQntServicosMensais)
        {
            int contadorServicosMes = 0;
            try
            {
                //DataPoint graficoArea, graficoLinha;
                DataPoint graficoArea = new DataPoint(BunifuDataViz._type.Bunifu_area);
                DataPoint graficoLinha = new DataPoint(BunifuDataViz._type.Bunifu_line);
